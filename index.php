...
<body id="Home" class="bg-light bg-img">
    ...
    <div class="container bg-white py-5 my-0">
        ...
        <!-- お稽古のご案内 -->
        <div id="keiko" class="">
        <h2 class="text-center mt-5 py-3 border-top border-success m-title ">お稽古場のご案内</h2>
            <div class="ml-0">

                <div class="d-flex flex-wrap-reverse justify-content-center">
                    <div class="col-md-6 col-10 p-0 align-self-center pl-5 mini-text">
                ...
                <div class="d-flex flex-wrap justify-content-center">
                    <div class="col-md-6 col-10 p-0 align-self-center">
                        ...
                        <img class="img-fluid" src="img/keiko-morioka.jpg" alt="objectfit" />
                    </div>
                    
                    <div class="col-md-6 col-10 align-self-center p-5 mini-text">
        ...
        <button type="button" class="btn btn-outline-success btn-lg btn-block my-3 mini-text" disabled>[準備中]他のお稽古場を見る</button>
        </div>
            <!-- お稽古のご案内 -->
