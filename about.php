...
<body id="Home" class="bg-light bg-img">
    <header class="sticky-top">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand m-auto text-center" href="index.php">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav pl-5">
                    ...
                    <a class="nav-item nav-link" href="index.php#keiko">お稽古場のご案内</a>
                    <a class="nav-item nav-link" href="https://www.facebook.com/%E6%97%A5%E6%9C%AC%E8%88%9E%E8%B8%8A-%E7%9B%B4%E6%B4%BE%E5%88%86%E5%AE%B6%E8%8B%A5%E6%9F%B3%E6%B5%81-319206524870126">活動の様子</a>
                    <a class="nav-item nav-link" href="index.php#contact">お問い合わせ</a>
                </div>
            </div>
        </nav>
    </header>
    ...
    <div class="container bg-white py-5 my-5 contents">
        ...
        <div id="icon" class="contents_innner">
            ...
            <div class="row d-flex justify-content-around m-4 ">
                ...
                <h5 class="mt-3">
                  ...
                  <div class="text-right w-100"><h4 class="my-3">直派分家若柳流<br> 初代家元 若柳壽宏</h4></div>
            </div>
        </div>
        <!-- 直派分家若柳流について-->
        ...
        <div id="original" class="contents_innner">
            ...
            <div class=" p-0 align-self-center  mini-text mx-5">
                ...
                <div class="py-3">
                    <h4 class="title ">若柳の賀<span class="h6"><br>昭和49年8月30日</span></h4>
                        ...
                        <div id="carouselExampleFade" class="carousel slide carousel-fade mx-5" data-ride="carousel">
                            <div class="carousel-inner ">
                                ...
                                <div class="carousel-item">
                                    <img src="img/ryubu-2.jpg" class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" height="80%">
                                </div>
                                <div class="carousel-item">
                                    <img src="img/ryubu-3.jpg" class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" height="80%">
                                </div>
                            </div>
                        </div>
                        <!-- スライドショー -->
                ...
                <div class="py-3">
                    <h4 class="title">華壽(はなのじゅ) <span class="h6"><br>昭和50年8月24日</span></h4>
                    <div class="pb-2 h5 text-i">
                        ...
                        <div id="carouselExampleFade" class="carousel slide carousel-fade mx-5" data-ride="carousel">
                            <div class="carousel-inner ">
                                <div class="carousel-item active ">
                                    <img src="img/ryubu-4.jpg" class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" height="80%">
                                </div>
                            </div>
                        </div>
                        <!-- スライドショー -->
                ...
                <div class="py-3">
                    <h4 class="title">百合の頌(ゆりのしょう) <span class="h6"><br>昭和53年12月1日</span></h4>
                    <div class="pb-2 h5 text-i">
                ...
                <div class="py-3">
                    <h4 class="title">桜譜(さくらのふ)<br>
                        福壽宏(ふくじゅこう) <span class="h6"><br>昭和56年5月21日</span></h4>
                    <div class="pb-2 h5 text-i">
                        ...
                        <div id="carouselExampleFade" class="carousel slide carousel-fade mx-5" data-ride="carousel">
                            <div class="carousel-inner ">
                                <div class="carousel-item active ">
                                    <img src="img/ryubu-5.jpg" class="bd-placeholder-img bd-placeholder-img-lg d-block w-100" height="80%">
                                </div>
                            </div>
                        </div>
                        <!-- スライドショー -->
                ...
                <div class="py-3">
                    <h4 class="title">二人西王母(にんんせいおうぼ)<span class="h6"><br>昭和62年5月27日</span></h4>
                    <div class="pb-2 h5 text-i">
                ...
                <div class="py-3">
                    <h4 class="title">四季の花うばら(しきのはなうばら) <span class="h6"><br>平成3年9月25日</span></h4>
                    <div class="pb-2 h5 text-i">
                ...
                <div class="py-3">
                    <h4 class="title">牡丹讃歌(ぼたんさんか) <span class="h6"><br>平成7年6月25日</span></h4>
                    <div class="pb-2 h5 text-i">
                ...
                <div class="py-3">
                    <h4 class="title">松を舞う(まつをまう)<br>
                        竹を壽ぐ(たけをことほぐ) <span class="h6"><br>平成11年6月29日</span></h4>
                    <div class="pb-2 h5 text-i">
                ...
                <div class="py-3">
                    <h4 class="title">壽櫻の山姥(はなのやまんば)<span class="h6"><br>平成15年4月30日</span></h4>
                    <div class="pb-2 h5 text-i">
